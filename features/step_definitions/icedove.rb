...
When /^I enter my email credentials into the autoconfiguration wizard$/ do
  ...
  icedove_wizard.child('Your name:', roleName: 'entry').typeText(name)
  icedove_wizard.child('Email address:', roleName: 'entry').typeText(address)
  icedove_wizard.child('Password:', roleName: 'entry').typeText(password)
